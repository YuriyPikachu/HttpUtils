...
import net.tatans.rhea.network.http.*;
...
import net.tatans.rhea.network.http.client.DefaultSSLSocketFactory;
import net.tatans.rhea.network.http.client.HttpRequest;
import net.tatans.rhea.network.http.client.RetryHandler;
import net.tatans.rhea.network.http.client.entity.GZipDecompressingEntity;
import net.tatans.rhea.network.task.PriorityExecutor;
...
public class HttpUtils {
    ...
    public <T> HttpHandler<T> post( String url, RequestParams params,
                                   RequestCallBack<T> callBack) {
        return send(HttpRequest.HttpMethod.POST, url, params, callBack);
    }
    public <T> HttpHandler<T> post( String url, RequestCallBack<T> callBack) {
        return send(HttpRequest.HttpMethod.POST, url, null, callBack);
    }
    public <T> HttpHandler<T> get( String url, RequestParams params,
                                    RequestCallBack<T> callBack) {
        return send(HttpRequest.HttpMethod.GET, url, params, callBack);
    }
