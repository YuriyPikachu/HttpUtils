...
import net.tatans.rhea.network.http.client.entity.BodyParamsEntity;
import net.tatans.rhea.network.http.client.multipart.HttpMultipartMode;
import net.tatans.rhea.network.http.client.multipart.MultipartEntity;
import net.tatans.rhea.network.http.client.multipart.content.ContentBody;
import net.tatans.rhea.network.http.client.multipart.content.FileBody;
import net.tatans.rhea.network.http.client.multipart.content.InputStreamBody;
import net.tatans.rhea.network.http.client.multipart.content.StringBody;
import net.tatans.rhea.network.task.Priority;
